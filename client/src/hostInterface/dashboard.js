    ...
    render() {
        ...
        return(
            <div className="bg-light" style={styleViewPort}>
                ...
                <div className='bg-light pt-5 mt-5 mr-5'>
                        ...
                        <div className='col-5  offset-1 mt-2'>
                            <div className='row p-3' style={{background: '#FFFFFF',"boxShadow":"0px 6px 18px rgba(0, 0, 0, 0.08)","borderRadius":"4px"}}>
                                ...
                                <div className='row '>
                                    ...
                                    >Show :</p>
                                    <Button className='col-lg-2 col-3  mr-2 btn-pos no-border' style={{height:'70%',fontSize:'80%', background:"#2ED47A", color:'white'}}  onClick={(e)=> this.updateNotificationFilters(e)}
                                    >
                                        Requests
                                    </Button>
                                    <Button className='col-lg-2 col-3  mr-2 pr-4 btn-pos no-border' style={{height:'70%',fontSize:'80%',background:"#FFFFFF",color:'#FE8D86'}}   onClick={(e)=> this.updateNotificationFilters(e)}
                                    >
                                        Upcoming
                                    </Button>
                                    <Button className='col-lg-2 col-3  mr-2 pr-2 btn-pos ' style={{height:'70%',fontSize:'80%',background:"#FFFFFF",color:'#5E239D'}}   onClick={(e)=> this.updateNotificationFilters(e)}
                                    >
                                        Ongoing
                                    </Button>
                                    <Button className='col-lg-2 col-3  mr-2 pr-5 btn-pos ' style={{height:'70%',fontSize:'80%',background:"#6C7B8A",color:'#FFFFFF'}}  onClick={(e)=> this.updateNotificationFilters(e)}
                                    >
                                        Completed
                                    </Button>
                                </div>
