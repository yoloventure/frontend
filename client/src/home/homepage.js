          ...
          <div style={{backgroundImage: "url(" + Background + ")"}}>
            <div className='col-12  pt-4 pl-5'>
              ...
              <div className='  pt-4'  style={{paddingBottom:'6%'}}>
                <Link to="explore" className=' '>
                  <div className=' row offset-1 hoverButton' style={{border: "5px solid #ffffff", height:"5%", width:"60%", boxSizing:"border-box"}}>

                    <div className="col-sm-10 pt-2">
                      <h2  className='' style={{textDecoration:'none',"fontFamily":"Mplus 1p","fontStyle":"normal","fontWight":"normal","fontSize":"4vh","lineHeight":"163.35%","alignItems":"center","color":"#FCFCFC"}}
            ...
            <div className='container'>
              ...
              <div className='row d-flex justify-content-center'>
                <h3 className=" text-center d-flex justify-content-center" style={{"fontFamily":"Mplus 1p","fontStyle":"normal","fontWeight":"normal","fontSize":"7hw","lineHeight":"67px","color":"#30233D"}}
                > What we do is more than you can imagine </h3>
              </div>

              <div className='row pt-5'>
                <div className='col-4 d-flex justify-content-center'>
                  <h1 style={{"fontFamily":"Mplus 1p","fontStyle":"normal","fontWeight":"900","fontSize":"8.2vw","lineHeight":"118px","textAlign":"center","color":"#F61067"}}
                  > 35 </h1>
                </div>

                <div className='col-4'>
                  <h1 style={{"fontFamily":"Mplus 1p","fontStyle":"normal","fontWeight":"900","fontSize":"8.2vw","lineHeight":"118px","textAlign":"center","color":"#5E239D"}}
                  > 142 </h1>

                </div>

                <div className='col-4'>
                  <h1 style={{"fontFamily":"Mplus 1p","fontStyle":"normal","fontWeight":"900","fontSize":"8.2vw","lineHeight":"118px","textAlign":"center","color":"#00F0B5"}}
                  > 12 </h1>
