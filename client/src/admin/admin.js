            ...
            for (var i = 0; i < data.length; i++) {
              this.setState((prevState) => {
                ...
                if (data[i].approval == "Approved") {
                  acceptedTemp[data[i]._id] = data[i];
                }
                if (data[i].approval == "Rejected") {
                  rejectedTemp[data[i]._id] = data[i];
                }
                if (data[i].approval == "pending") {
                  pendingTemp[data[i]._id] = data[i];
                }
      ...
      <div className="container-fluid app">
        ...
        <div className="container">
          ...
          {this.state.appsLoaded ? (
            <ShowAllItem
              acceptedItem={this.state.accepted}
              rejectedItem={this.state.rejected}
              pendingItem={this.state.pending}
              allItem={this.state.hostApps}
              acceptHost={this.acceptHost}
              rejectHost={this.rejectHost}
            >
              {" "}
            </ShowAllItem>
          ) : null}
