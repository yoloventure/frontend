      ...
      <div>
        ...
        <div>
          <Modal
            ...
            actions={<></>}
          >
            {Object.keys(acceptedItem).map((item, i) => (
              <HostApplicationItem
                key={i}
        ...
        <div>
          <Modal
            ...
            actions={<></>}
          >
            {Object.keys(rejectedItem).map((item, i) => (
              <HostApplicationItem
                key={i}
                item={rejectedItem[item]}
                modify={false}
              >
                {" "}
              </HostApplicationItem>
        ...
        <div>
          <Modal
            ...
            actions={<></>}
          >
            {Object.keys(pendingItem).map((item, i) => (
              <HostApplicationItem
                key={i}
        ...
        <div>
          <Modal
            ...
            actions={<></>}
          >
            {Object.keys(allItem).map((item, i) => (
              <HostApplicationItem
                key={i}
                item={allItem[item]}
                modify={true}
                acceptHost={this.props.acceptHost}
                rejectHost={this.props.rejectHost}
              >
                {" "}
              </HostApplicationItem>
            ))}
