...
export default class Demo extends React.Component {
  constructor(props) {
    ...
    this.state = {
      open1: true, //set to true so it is open on page reload
      open2: false,
      open3: false,
      rating: 0,
      review: "",
        ...
        >
          ...
          <DialogContent>
            <DialogContentText>
              ...
              >
                How would you recommend the host to other shadowers? Tell
                shadowers and hosts what you liked and what you wish was
                different!
              </div>
            </DialogContentText>
          </DialogContent>
        ...
        {this.state.open2 ? (
          ...
          >
            <DialogTitle id="form-dialog-title">
              ...
              >
                How likely are you to recommend the host to other shadowers?
              </div>
            </DialogTitle>
            <DialogContent>
              ...
              <div className="rating">
                <div class="row justify-content-md-center">
                  <div className=" col col-md-2 ratingText">
                    {" "}
                    Not at all likely{" "}
                  </div>
          ...
          >
            ...
            <DialogContent>
              <DialogContentText>
                ...
                >
                  Reviews are published after both you and your host have
                  completed the reviews, or when the 14-day review period has
                  ended.
                </div>
              </DialogContentText>
