    ...
    return (
      <div className="container-fluid app">
        ...
        <p className="text-left">
          Yolo is a job shadowing marketplace that connects locals and travelers
          for authentic job shadow experiences. Locals can earn extra income for
          hosting job shadow experiences that are unique to their culture and
          tradition. Travelers get to experience working in a new city or a new
          field for a short period of time (1-3 days). Yolo is a job shadowing
          marketplace for two parties to exchange work experience, culture and
          knowledge. 
        </p>
        ...
        <div className="row">
          ...
          <div className="col">
            ...
            <p>
              Infuse your business with a different point of view and innovative
              ideas.
            </p>

            <strong>Grow your brand</strong>
            <p>
              Bring people along on your business journey and create a community
          ...
          <div className="col">
            ...
            <p>
              Starting or changing career is daunting, we make it easy to sample
              new industries and companies before committing.
            </p>
            <strong>Grow your brand</strong>
            <p>
